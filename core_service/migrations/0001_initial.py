    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_type', models.CharField(choices=[('email', 'EMAIL'), ('phone', 'PHONE')], max_length=7)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('byd_internal_id', models.CharField(max_length=20, unique=True)),
                ('byd_metadata', models.JSONField(default=dict)),
                ('vendor_settings', models.JSONField(blank=True, default=dict)),
