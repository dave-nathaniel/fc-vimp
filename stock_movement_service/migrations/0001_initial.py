# Generated by Django 4.2 on 2025-07-28 07:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity_issued', models.DecimalField(decimal_places=3, default=0.0, max_digits=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_status_code', models.CharField(choices=[('1', 'Not Delivered'), ('2', 'Partially Delivered'), ('3', 'Completely Delivered')], default='1', max_length=1)),
                ('metadata', models.JSONField(default=dict)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_issue', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='receipts', to='stock_movement_service.goodsissuenote')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata', models.JSONField(blank=True, default=dict, null=True)),
                ('goods_issue_line_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='receipt_items', to='stock_movement_service.goodsissuelineitem')),
                ('transfer_receipt', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='line_items', to='stock_movement_service.transferreceiptnote')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata', models.JSONField(default=dict)),
                ('sales_order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='line_items', to='stock_movement_service.salesorder')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='sales_order',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='goods_issues', to='stock_movement_service.salesorder'),
        ),
        migrations.AddField(
            model_name='goodsissuenote',
            name='source_store',
        ...
        migrations.AddField(
            ...
            name='goods_issue',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='line_items', to='stock_movement_service.goodsissuenote'),
        ),
        migrations.AddField(
            model_name='goodsissuelineitem',
            name='sales_order_line_item',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='goods_issue_items', to='stock_movement_service.salesorderlineitem'),
        ),
        migrations.CreateModel(
            name='StoreAuthorization',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('manager', 'Store Manager'), ('assistant', 'Store Assistant'), ('admin', 'Administrator')], max_length=50)),
