...
def check_inventory_availability(byd_cost_center_code, line_items):
    """
    ...
    logger.info(f"Checking inventory availability for store {byd_cost_center_code}")
    ...
    try:
        with transaction.atomic():
            ...
            try:
                StoreAuthorizationValidator.validate_store_access(
                    request.user, 
                    source_store.byd_cost_center_code,
